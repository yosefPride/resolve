            ...
            web::scope("/ai")
                .service(
                    web::scope("/groups/{id}/tickets/{ticket_id}")
                        ...
                        .route("/chat", web::post().to(ai_handlers::send_chat_message))
                        .route("/chat", web::get().to(ai_handlers::list_chat_messages))
                        .route("/chat", web::delete().to(ai_handlers::clear_chat)),
                )
                .route(
                    "/groups/{id}/report",
