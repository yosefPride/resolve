...
// specification/api.md: POST .../summarize, .../analyze). Matches the height
// of the Details/Comments tab panels so the rail lines up with the main
// column. Everything is disabled until those endpoints exist.
export default function AiPanel({ ticket }) {
  return (
    <div className="flex h-128 flex-col rounded-xl border border-white/10 bg-white/5">
